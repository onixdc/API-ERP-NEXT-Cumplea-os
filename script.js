...
function cumpleHoy() {
    const URL = 'http://192.168.0.13/api/resource/Employee?fields=["employee_name","date_of_birth"]';
    fetch(URL,
        {
            method:'GET',
            headers:{
...
function FestejadosHoy(_data) {
    ...
    for (var i = 0; i < arrayFilter.length; i++) {
        _tblStr += "<p class='cssFontB1'>" + arrayFilter[i].employee_name + "</p>";
    }
...
function cumpleMes() {
    const URL2 = 'http://192.168.0.13/api/resource/Employee?fields=["employee_name","date_of_birth"]';
